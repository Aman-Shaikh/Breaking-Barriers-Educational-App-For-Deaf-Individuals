...
public class QuizActivity2 extends AppCompatActivity {
    ...
    ViewPagerAdapter10 viewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    if (getitem(0) < 26)
                        ...
                        Intent i = new Intent(QuizActivity2.this,MainScreen.class);
                        startActivity(i);
                        finish();
        ...
        viewPagerAdapter = new ViewPagerAdapter10(this);
    ...
    private void changenextquestion()
    {
        ...
        {
            selectedoption="";
            option1.setBackgroundResource(R.drawable.round_back_black_stroke2_10);
            option1.setTextColor(Color.parseColor("#1F6888"));

            option2.setBackgroundResource(R.drawable.round_back_black_stroke2_10);
            option2.setTextColor(Color.parseColor("#1F6888"));

            option3.setBackgroundResource(R.drawable.round_back_black_stroke2_10);
            option3.setTextColor(Color.parseColor("#1F6888"));

            option4.setBackgroundResource(R.drawable.round_back_black_stroke2_10);
        ...
        {
            Intent intent=new Intent(QuizActivity2.this,QuizResults.class);
